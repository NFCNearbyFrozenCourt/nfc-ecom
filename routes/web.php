...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('/sells/drafts/ecom', [SellController::class, 'getDraftsEcom']);
    ...
    Route::get('ecom-sales', [SalesOrderController::class, 'ecomOrders']);
    Route::get('/show-ecom/{id}', [SellController::class, 'showEcom']);
