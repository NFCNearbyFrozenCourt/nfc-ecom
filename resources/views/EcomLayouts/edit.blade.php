...
<input type="hidden" id="item_addition_method" value="{{$business_details->item_addition_method}}">
	...
	<div class="row">
		<div class="col-md-12 col-sm-12">
				...
				<div class="row col-sm-12" style="min-height: 0" style="display: none;">

					<input type="hidden" name="sell_price_tax" id="sell_price_tax" value="{{$business_details->sell_price_tax}}">

					<!-- Keeps count of product rows -->
					<input type="hidden" id="product_row_count" 
						value="{{count($sell_details)}}" style="display: none;">
					@php
						$hide_tax = '';
				...
				<div class="col-md-4 @if($transaction->type == 'sales_order') hide @endif" style="display: none;">
			        <div class="form-group">
			    ...
			    <div class="col-md-4 @if($transaction->type == 'sales_order') hide @endif" style="display: none;"><br>
			    ...
			    <div class="col-md-4 col-md-offset-4 @if($transaction->type == 'sales_order') hide @endif" style="display: none;">
	...
	@component('components.widget', ['class' => 'box-solid', 'title' => "Payment Method"])
    <div class="form-group">
        <label style="display: flex; align-items: center; gap: 10px;">
            <input type="radio" name="payment_method" class="flexRadioDefault" value="cash" style="transform: scale(1.5);" onclick="openPaymentModal()"> Cash
        </label><br>
        <label style="display: flex; align-items: center; gap: 10px;">
            <input type="radio" name="payment_method" class="flexRadioDefault" value="qr" style="transform: scale(1.5);"> QR
        </label><br>
        <label style="display: flex; align-items: center; gap: 10px;">
            <input type="radio" name="payment_method" class="flexRadioDefault" value="sms_link" style="transform: scale(1.5);"> SMS Link
        </label>
    </div>
@endcomponent
...
@can('sell.payments')
    @component('components.widget', ['class' => 'box-solid', 'title' => __('purchase.add_payment')])
        <div class="well row" id="cashModal" style="display: none;">
            <div class="col-md-6">
                <div class="form-group">
...
<script>
    function openPaymentModal() {
        document.getElementById('cashModal').style.display = 'flex'; // or 'block' if needed
    }
</script>
	@php
	...
	@if($is_enabled_download_pdf && $transaction->type != 'sales_order')
		@can('sell.payments')
			@component('components.widget', ['class' => 'box-solid', 'title' => __('purchase.add_payment')])
				<div class="well row" style="display: none">
					<div class="col-md-6" >
						<div class="form-group">
							{!! Form::label("prefer_payment_method" , __('lang_v1.prefer_payment_method') . ':') !!}
							@show_tooltip(__('lang_v1.this_will_be_shown_in_pdf'))
	...
	@can('sell.payments')
		...
		<div class="row" style="display: none">
			@foreach($payment_lines as $payment_line)			
        		...
        		@endif
				<div class="payment_row" id="payment_rows_div" style="display: none">
...
@section('javascript')
    ...
    <script>
        $(document).ready(function () {
    setTimeout(function () {
        $("#invoice_no").val(""); // Reset invoice number
        $("#status").val("final").trigger("change"); // Change status to "final"
