                    ...
                    <div class="checkbox">
                        ...
                        <label>
                            <div class="icheckbox_square-blue" style="position: relative;">
                                ...
                                <input type="hidden" name="enable_ecommerce" value="0">
                                
                                <!-- Checkbox that overrides the value when checked -->
                                <input class="input-icheck" name="enable_ecommerce" type="checkbox" value="1" 
                                    {{ $location->enable_ecommerce ? 'checked' : '' }} 
                        ...
                        <i class="fa fa-info-circle text-info hover-q no-print" aria-hidden="true" 
                           ...
                           data-content="Check this field to enable e-commerce functionality for this location."
