    ...
    <div class="{{$col_class}}">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {!! Form::text("payment[$row_index][amount]", @num_format(0.00), ['class' => 'form-control input_number', 'required', 'placeholder' => __('sale.amount'), 'readonly' => $readonly]); !!}
            </div>
        </div>
    </div>
    @if(!empty($show_date))
    ...
    <div class="{{$col_class}}">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                @php
                $_payment_method = !empty($payment_line['method']) ? $payment_line['method'] : (array_key_exists('', $payment_types) ? '' : 'cash');
                @endphp
    ...
    <div class="{{$col_class}}">
        <div class="form-group @if($readonly) hide @endif">
            ...
            <div class="input-group">
                ...
                {!! Form::select("payment[$row_index][account_id]", $accounts, $payment_line['account_id'] ?? '', ['class' => 'form-control select account-dropdown', 'style' => 'width:100%;', 'disabled' => $readonly]); !!}
            </div>
        </div>
    </div>
    @endif
