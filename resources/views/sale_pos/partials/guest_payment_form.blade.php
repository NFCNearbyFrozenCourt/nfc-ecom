            ...
            <div class="box box-primary">
                <div class="box-body">
                    ...
                    @if($transaction->payment_status != 'paid')
                        ...
                        <div class="row">
                            <button id="renderBtn" class="cashfree-btn">Pay with Cashfree</button>
                        </div>
                        ...
                        <style>
                            .cashfree-btn {
                                ...
                                width: 100%; /* Covers full width of the parent container */
                                display: block; /* Ensures proper width coverage */
                                text-align: center;
                            }
                        
                            .cashfree-btn:hover {
                                background-color: #4f2399; /* Darker shade for hover effect */
                            }
                        </style>

                        <script>
                            const cashfree = Cashfree({
                                mode: "{{ $paymentMode == 'test' ? 'sandbox' : 'production' }}"
                            });
