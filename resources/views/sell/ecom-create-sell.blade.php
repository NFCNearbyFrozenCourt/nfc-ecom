...
<section class="content no-print">
		...
		<div class="col-md-12 col-sm-12">
			...
			<div class="@if(!empty($commission_agent)) col-sm-3 @else col-sm-4 @endif">
				<div class="form-group">
					...
					{!! Form::select('status', $statuses, 'final', ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'required']); !!} </div>
			</div>
			@endif
			@if($sale_type != 'sales_order')
			<div class="col-sm-3">
	...
	@for($i; $i <= 6 ; $i++)
		...
		<div class="payment_row" @if($is_enabled_download_pdf) id="payment_rows_div" @endif>
			...
			@include('sale_pos.partials.ecom_payment_row_form', ['row_index' => 0, 'show_date' => true, 'show_denomination' => true])
		</div>
