<div class="pos-tab-content">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="col-sm-4">
            <div class="form-group">
              {!! Form::label('cashfree_account_id', ('Account ID') . ':') !!}
              {!! Form::text('pos_settings[cashfree_account_id]', $pos_settings['cashfree_account_id'] ?? '', ['class' => 'form-control', 'id' => 'cashfree_account_id']); !!}
            </div>
          </div>
          <div class="col-sm-4">
            <div class="form-group">
              {!! Form::label('cashfree_api_key', ('Api Key') . ':') !!}
              {!! Form::text('pos_settings[cashfree_api_key]', $pos_settings['cashfree_api_key'] ?? '', ['class' => 'form-control', 'id' => 'cashfree_api_key']); !!}
            </div>
          </div>
          <div class="col-sm-4">
            <div class="form-group">
              {!! Form::label('cashfree_secret_key', ('Secret Key') . ':') !!}
              {!! Form::text('pos_settings[cashfree_secret_key]', $pos_settings['cashfree_secret_key'] ?? '', ['class' => 'form-control', 'id' => 'cashfree_secret_key']); !!}
            </div>
          </div>
          <div class="col-sm-4">
            <div class="form-group">
              {!! Form::label('cashfree_environment', ('Environment') . ':') !!}
              {!! Form::select('pos_settings[cashfree_environment]', 
                  ['test' => 'Test', 'production' => 'Production'], 
                  $pos_settings['cashfree_environment'] ?? 'test', 
                  ['class' => 'form-control', 'id' => 'cashfree_environment']); !!}
            </div>
          </div>
