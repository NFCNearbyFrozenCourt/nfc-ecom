...
<section class="content-header no-print">
    <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">Firebase Settings</h1>
</section>
...
<section class="content no-print">
    <div class="tw-max-w-3xl tw-mx-auto">
        <div class="tw-bg-white tw-shadow-md tw-rounded-lg tw-p-6">
            <h2 class="tw-text-lg tw-font-semibold tw-mb-4">Update Firebase Settings</h2>

            <form action="{{ route('firebase.settings.update') }}" method="POST">
                @csrf
                @method('POST')
